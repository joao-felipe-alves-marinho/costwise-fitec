...
export async function updateProject(id: number, data: Partial<ProjectData>): Promise<Project | null> {
...
export async function totalCostMember(id: number): Promise<MembersCosts | null> {
...
export async function totalCostProductsByType(id: number): Promise<ProductByTypeCost | null> {
...
export async function totalCostProductsByLicense(id: number): Promise<ProductByLicenseCost | null> {
